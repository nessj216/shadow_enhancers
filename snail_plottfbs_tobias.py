...
with open("/Users/jillianness/Downloads/TF_Binding_4-15-24_Sample_TOBIAS_chr/BINDetect_4-15_4-16_picard_Dl_Sna_Twist/SNAPROXcat_filesall.txt", "r") as file:
...
plt.savefig("/Users/jillianness/Desktop/TFBS_tobias_figures/SNAPROX_julia___highres", dpi=300, bbox_inches='tight')
plt.show()
# Show the plot
