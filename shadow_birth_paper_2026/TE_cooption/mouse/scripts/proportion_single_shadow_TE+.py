...
# ── Data ─────────────────────────────────────────────────────────────────────
labels  = ['shadows\n(n=19,166)', 'singles\n(n=6,363)']
te_pos  = np.array([1440, 480])
totals  = np.array([19166, 6363])
...
ax.grid(False)
plt.tight_layout()
plt.savefig(OUTPUT_FIGURES / "mouse_proportion_single_shadow.png", dpi=600,
...
plt.tight_layout()
plt.savefig(
    OUTPUT_FIGURES / "mouse_proportion_single_shadow_2.png",
