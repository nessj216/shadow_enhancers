...
# ====== Inputs ======
te_minus_sets = 9051-1785  # terminus– (TE–) sets
te_plus_sets  = 1785 #20percent  # terminus+ (TE+) sets
total_sets = te_minus_sets + te_plus_sets

te_plus_breakdown = {
    "1 TE+ enhancer/set": 1545,
    "2 TE+ enhancers/set": 200,
    "3 TE+ enhancers/set": 40,
}
...
plt.tight_layout()
plt.savefig(OUTPUT_FIGURES / "mouse_te_nested_donut_green.png", dpi=DPI, bbox_inches="tight", transparent=True)
plt.show()
...
plt.tight_layout()
plt.savefig(OUTPUT_FIGURES / "_te_nested_donut_splitting.png", dpi=DPI, bbox_inches="tight", transparent=True)
plt.show()
