...
# ====== Inputs ======
te_minus_sets = 9051-162   # terminus– (TE–) sets
te_plus_sets  = 162    # terminus+ (TE+) sets
...
plt.tight_layout()
plt.savefig("te_nested_donut_splitting.png", dpi=DPI, bbox_inches="tight", transparent=True)
plt.show()
